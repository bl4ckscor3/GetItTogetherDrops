...
public class GetItTogetherDrops {
	...
	public static final TagKey<Item> IGNORED = ItemTags.create(Identifier.fromNamespaceAndPath(MODID, "ignored"));
	public static final TagKey<Item> DO_NOT_COMBINE = ItemTags.create(Identifier.fromNamespaceAndPath(MODID, "do_not_combine"));
